...
Chrome extension that shows recent reported crime from police open data as a heatmap on Google Maps, and rates running routes. Covers 13 areas so far: 12 of the 50 largest US cities plus Rochester, NY. See [COVERAGE.md](COVERAGE.md) for the 50 largest US cities.
